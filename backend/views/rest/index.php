...
<div class="container">
	...
	<pre>
		...
		<span class="text-success">class</span> UserController <span class="text-success">extends</span> ActiveController
		{
			...
			<span class="text-success">public function</span> actions()
			{
				...
				<span class="text-warning">unset</span>($actions['delete'], $actions['create']);
	...
	<pre>
		...
		<b>&lt;fkuser&gt;</b> Es el id del usuario con al que se le creará el perfil
	</pre>
...
<div class="container" ng-controller="profilecontroller">
	<div class="form-inline">
		...
		<select ng-model="user">
			<option ng-repeat="element in user">{{element.Usuario}}</option>
		</select>
	</div>
	<div class="form-inline">
		<label>Cédula: </label>
